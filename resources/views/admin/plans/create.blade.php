                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" 
                                   ...
                                   placeholder="Medicare Advantage Plan">
                            @error('title')
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="Detailed description of the plan benefits and coverage">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('color') is-invalid @enderror" 
                                       id="color_text" name="color_text" value="{{ old('color', '#007bff') }}" 
                    ...
                    <div id="benefits-container">
                        <div class="benefit-item mb-3">
                            <div class="row align-items-end">
                                <div class="col-md-10">
                                    <label class="form-label font-weight-bold">Benefit</label>
                                    <input type="text" name="benefits[]" class="form-control" 
                                           placeholder="e.g., $0 annual deductible" value="{{ old('benefits.0') }}">
                                </div>
                                <div class="col-md-2">
                                    <div class="btn-group w-100">
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm remove-benefit" title="Remove" style="display: none;">
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        <li class="mb-2">
                            ...
                            <small>Plan title should be descriptive and unique</small>
                        </li>
                        <li class="mb-2">
                            <i class="fas fa-check-circle text-success mr-2"></i>
                            <small>Slug will be used in URLs and API endpoints</small>
                        </li>
                        <li class="mb-2">
                            <i class="fas fa-check-circle text-success mr-2"></i>
                            <small>Add detailed benefits to help users compare</small>
                        </li>
                        <li class="mb-2">
                            <i class="fas fa-check-circle text-success mr-2"></i>
                            <small>Choose colors that match your brand theme</small>
                        </li>
                        <li class="mb-0">
                            <i class="fas fa-check-circle text-success mr-2"></i>
                            <small>Inactive plans are hidden from user enrollment</small>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div id="plan-preview" class="text-center p-3 border rounded" style="background-color: #f8f9fc;">
                        ...
                        <p id="preview-description" class="text-muted small">Plan description will appear here</p>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updatePreview() {
        ...
        // Update icon
        const icon = iconInput.value || 'fas fa-clipboard-list';
